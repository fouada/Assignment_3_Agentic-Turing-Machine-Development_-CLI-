...
<p align="center">
  <img src="results/semantic_drift_analysis_local.png" alt="Semantic Drift Analysis - Multi-Agent Translation Pipeline" width="800">
</p>

<p align="center">
  <em>Figure 1: Semantic drift metrics across different noise levels (0-50%). Generated by <code>analyze_results.py</code></em>
</p>

**📥 Download:** [PNG Image](results/semantic_drift_analysis_local.png) | [PDF Version](results/semantic_drift_analysis_local.pdf)

**Key Observations from the Visualization:**
- **Semantic Distance (Top-Left):** Cosine distance remains constant at 0.2894 across all noise levels (0-50%)
- **Text Similarity (Top-Right):** Character-level similarity maintains 98.93% even at 50% noise
- **Word Overlap (Bottom-Left):** Jaccard similarity stays at 88.89% across all conditions
- **Combined Metrics (Bottom-Right):** All normalized metrics show remarkable stability
